        ...
        L.tileLayer(
            ...
            L.marker([40.742718, -73.989259], {icon: jupiterIcon}).addTo(map).bindPopup("<h1>jupiter<h1>Sitting atop a wall enclosing General Worth Monument, Jupiter, te largest planet in the wave 9 model, rests in the shadow of the Flatiron.<img src='imgs/Screenshot_jupiter.jpg' height=175px width=300px>"); 
