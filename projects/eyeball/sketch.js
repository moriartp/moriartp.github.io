...
function setup() {
  ...
  img = loadImage("img/eye_hal.png"); 

  //junk
  for (var i = 0; i < 122; i++) {//cities.length; i++) {
...
function draw() {
  ...
  for (var i = 0; i < 50; i++) {//cities.length; i++) {
  ...
  textSize(111);
  fill(255);
  text("watching",random(windowWidth/2-2,windowWidth/2+2), random(windowHeight/2-2, windowHeight/2+2));
