...
class __TwigTemplate_be341f086f1841cbc2e3b5dbe02a567992ba9f6ea6dd806e48261e8405bd52d7 extends Twig_Template
{
    ...
    <p>
        ...
        if ((isset($context["query"]) ? $context["query"] : null)) {
            // line 12
            echo "            ";
            $context["count"] = (((isset($context["search_results"]) ? $context["search_results"] : null)) ? ($this->getAttribute((isset($context["search_results"]) ? $context["search_results"] : null), "count", array())) : (0));
            // line 13
            echo "            ";
            if (((isset($context["count"]) ? $context["count"] : null) == 1)) {
                // line 14
                echo "                ";
                echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->translate("PLUGIN_SIMPLESEARCH.SEARCH_RESULTS_SUMMARY_SINGULAR", twig_escape_filter($this->env, (isset($context["query"]) ? $context["query"] : null)));
                echo "
            ";
            } else {
                // line 16
                echo "                ";
                echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->translate("PLUGIN_SIMPLESEARCH.SEARCH_RESULTS_SUMMARY_PLURAL", twig_escape_filter($this->env, (isset($context["query"]) ? $context["query"] : null)), (isset($context["count"]) ? $context["count"] : null));
                echo "
            ";
            }
            // line 18
...
{% endblock %}
", "simplesearch_results.html.twig", "/Users/pj_moriarty/Desktop/grav-admin/user/plugins/simplesearch/templates/simplesearch_results.html.twig");
    }
}
