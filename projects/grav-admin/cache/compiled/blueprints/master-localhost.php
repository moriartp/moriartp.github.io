...
return [
    ...
    'timestamp' => 1517277253,
    'checksum' => 'f7f59a17f4af9003e7bcddea90e982e5',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/fetchwp' => [
                'file' => 'user/plugins/fetchwp/blueprints.yaml',
                'modified' => 1516904008
            ],
            'plugins/form' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.fetchwp.enabled' => [
                ...
                'name' => 'plugins.fetchwp.enabled',
                'validation' => 'loose'
            ],
            'plugins.fetchwp.wordpress_fetch_settings' => [
                'type' => '_parent',
                'name' => 'plugins.fetchwp.wordpress_fetch_settings',
                'form_field' => false
            ],
            'plugins.fetchwp.wordpress_fetch_settings.blogurl' => [
                'type' => 'text',
                'size' => 'large',
                'label' => 'Blog-URL',
                'validate' => [
                ...
                'name' => 'plugins.fetchwp.wordpress_fetch_settings.blogurl',
                'validation' => 'loose'
            ],
            'plugins.fetchwp.wordpress_fetch_settings.count' => [
                'type' => 'text',
                'size' => 'small',
                ...
                'name' => 'plugins.fetchwp.wordpress_fetch_settings.count',
                'validation' => 'loose'
            ],
            'plugins.fetchwp.wordpress_fetch_settings.enableTranslation' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.fetchwp.wordpress_fetch_settings.enableTranslation',
                'validation' => 'loose'
            ],
            'plugins.fetchwp.wordpress_fetch_settings.enableFMedia' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.fetchwp.wordpress_fetch_settings.enableFMedia',
                'validation' => 'loose'
            ],
            'plugins.fetchwp.wordpress_fetch_settings.qualityFMedia' => [
                'type' => 'select',
                ...
                'name' => 'plugins.fetchwp.wordpress_fetch_settings.qualityFMedia',
                'validation' => 'loose'
            ],
            'plugins.fetchwp.wordpress_fetch_settings.altImage' => [
                ...
                'name' => 'plugins.fetchwp.wordpress_fetch_settings.altImage',
                'validation' => 'loose',
                'array' => true
            ],
            'plugins.fetchwp.wordpress_fetch_settings.sectiontitle' => [
                'type' => 'text',
                'size' => 'large',
                ...
                'name' => 'plugins.fetchwp.wordpress_fetch_settings.sectiontitle',
                'validation' => 'loose'
            ],
            'plugins.form' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'fetchwp' => [
                    'enabled' => 'plugins.fetchwp.enabled',
                    'wordpress_fetch_settings' => [
                        'blogurl' => 'plugins.fetchwp.wordpress_fetch_settings.blogurl',
                        'count' => 'plugins.fetchwp.wordpress_fetch_settings.count',
                        'enableTranslation' => 'plugins.fetchwp.wordpress_fetch_settings.enableTranslation',
                        'enableFMedia' => 'plugins.fetchwp.wordpress_fetch_settings.enableFMedia',
                        'qualityFMedia' => 'plugins.fetchwp.wordpress_fetch_settings.qualityFMedia',
                        'altImage' => 'plugins.fetchwp.wordpress_fetch_settings.altImage',
                        'sectiontitle' => 'plugins.fetchwp.wordpress_fetch_settings.sectiontitle'
                    ]
                ],
                'form' => [
