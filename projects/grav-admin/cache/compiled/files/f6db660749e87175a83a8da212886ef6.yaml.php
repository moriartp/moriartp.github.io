...
return [
    ...
    'filename' => '/Users/pj_moriarty/Desktop/grav-admin/user/plugins/admin/languages/en.yaml',
    'modified' => 1516899519,
    'data' => [
        'PLUGIN_ADMIN' => [
...
You have **2FA** enabled on this account. Please use your **2FA** app to enter the current **6-digit code** to complete the login process.',
            ...
            'VIEW_SITE_TIP' => 'View site in frontend',
            ...
            'TOOLS_DIRECT_INSTALL_URL_DESC' => 'Alternatively, uou can also reference a full URL to the package ZIP file and install it via this remote URL.'
        ]
    ]
];
